...
const StartLinearStreamWithCliff = ({ setStep, amountToStream, payeeAddress, dueDate, requestId, chain_id, payerAddress, durationInDays }: StartLinearStreamProps) => {
...
export default StartLinearStreamWithCliff