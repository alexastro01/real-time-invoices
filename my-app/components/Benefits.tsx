...
const Benefits = () => {
  return (
    ...
    <div className="container px-4 md:px-6 grid lg:grid-cols-1 gap-12">
      ...
      <div>
      <p className='max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed font-semibold text-green-600'>✅ With Real Time Invoicing</p> 
